...
\begin{align*}
[\enskip , \enskip ]: L \times L & \to  L \\
(x , \enskip y) & \mapsto [x,y] 
\end{align*}
...
Nous avons donc $\gl(n,\KK)=vect\{ { e_{ij}, \enskip 1 \leq i , j \leq n }\}$. Regardons l'effet du crochet de Lie sur deux éléments de la base:
\begin{center}
