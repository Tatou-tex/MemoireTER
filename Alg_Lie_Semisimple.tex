...
\title{\textbf{\scalebox{1.25}{Sur les Algèbres de Lie Semisimples}}}
\author{\bf Cassandre SAIZ \& Ezzahra ZLIGUI SAILLIER \\ \bf Encadrée par Stéphane BASEILHAC}
...
\centerline{Université de Montpellier, Montpellier, France}
\centerline{cassandre.saiz@etu.umontpellier.fr}
\centerline{ezzahra.zligui-saillier@etu.umontpellier.fr}
%\thispagestyle{fancy}
%\newpage
%\vspace{4mm}
%\clearpage
