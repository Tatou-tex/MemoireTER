...
\quad Dans se mémoire nous nous interreserons aux algèbres de Lie, plus particulièrement aux algèbres de Lie semisimples.

Les algèbres de Lie sont naturellement associées aux groupes de Lie. Nous étudirons pas dans ce rapport les groupes de Lie, cepandent les comprendre est l'une des raisons pour étudier les algèbres de Lie. Ces deux notions jouent un rôle aussi bien en mathématique qu'en physique. La théorie des groupes et d'algèbres de Lie commence à la fin du XIX\up{e} siècle, avec les travaux du mathématicien norvégien Sophus Lie.  Une théorie qui connait, encore aujourd'hui, de nombreuse ramifications.\\
...
\\
L'objectif de ce mémoire est d'arrivé à une caractérisation des algèbres de Lie semisimples. 

Dans un premier temps nous énoncerons les notions de base. Puis dans un deuxième temps, quelques théorèmes élémentaires serons donner et démontré.
