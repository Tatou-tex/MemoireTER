...
Cette formule est équivalente à  $[ e_{ii},e_{ij} ]  = e_{ij}$ pour $i<j$ $(\star)$.

Définisons le \textbf{niveau} d'un élément $e_{ij}$ comme l'entier $j-i$. 

Avec $(\star)$ on remarque que pour avoir un élément de niveau $1$ ou plus, il suffit de le commuter avec un élément de niveau $0$.
