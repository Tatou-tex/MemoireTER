...
Cette section nous est nécéssaire pour indroduire la notions d'adjoint, notion qui nous sera utile dans la suite de ce rapport. 
...
\quad Dans cette sous-section on considère uniquement $car$ $\KK$ quelconque. Nous sortons un peu du cadre des algèbre de Lie pour introduire un outil très utile dans l’étude des applications linéaires. Rappelons la forme de Jordan pour un endomorphisme $x$ sur un corps algébriquement clos. Sous forme matricielle c'est une matrice diagonals par blocs avec des bloc de la forme :
\begin{center}
$
\begin{pmatrix}
a & 1 & \cdots & 0 \\
